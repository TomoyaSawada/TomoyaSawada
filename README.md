## Tomoya SAWADA  
Tomoya Sawada is a Research Scientist/Engineer in Computer Vision at Mitsubishi Electric. He graduated from Yamanashi University, Japan in 2012, and received M.Sc. and Ph.D. degree from the department of computer science at the Yamanashi University, Japan in 2014 and 2015. His research interests include scene understanding such as object detection/semantic segmentation/object tracking/action recognition, AI assisted user interface, generating the natural scene using GAN and multimodal learning. 
...
### Patents
- "推論装置、推論方法及び推論プログラム"、澤田友哉、（三菱電機株式会社）、文書番号682613WO01. 
- "推論装置、推論方法及び推論プログラム"、澤田友哉、（三菱電機株式会社）、文書番号682612WO01. 　
