...
My leadership in this role has resulted in the delivery of **five impactful GenAI MVPs** across diverse business domains. Key achievements include deploying a sales intelligence tool that achieved **98% accuracy**, inventing a patented multi-agent system for automated proposal generation that **secured inquiries from pitched partners**, and building secure GenAI environments for major railway clients.
...
Collaborate with: Professor Antonio Ortega　</summary>
...
- P. Das, J. Kao, A. Ortega, T. Sawada, H. Mansour, A. Vetro, A. Minezawa, "**Hand Graph Representations for Unsupervised Segmentation of Complex Activities**," *2019 International Conference on Acoustics, Speech, and Signal Processing (ICASSP)*, pp.4075-4079, May 2019. *(Acceptance Rate: 49%)*
- T. Sawada, M. Toyoura, X. Mao, "**Auto‐Framing Based on User Camera Movement**," *Computer Graphics International (CGI)*, Article 18, June 2017. *(Acceptance Rate: 22%)*
- K. Fujimori, S. Zhu, T. Sawada, M. Toyoura, X. Mao, "**Image based Kansei-words Labeling by Game**," *NICOGRAPH International*, pp.81-86, Nov. 2014.
- T. Sawada, M. Toyoura, X. Mao, "**Film Comic Generation with Eye Tracking**," *International Conference on MultiMedia Modeling (MMM)*, LNCS, Vol.7732, pp.467‐478, Jan. 2013. *(Acceptance Rate: 20%)*
- M. Toyoura, T. Sawada, M. Kunihiro, X. Mao, "**Using Eye‐Tracking Data for Automatic Film Comic Creation**," *ACM Symposium on Eye Tracking Research & Applications (ETRA)*, pp. 373‐376, Mar. 2012. *(Acceptance Rate: 44%)*

---

#### Domestic Conference Presentations

*(A selection of presentations at academic conferences in Japan)*
...
### Patents
A portfolio of over 30 granted or pending patents, demonstrating sustained innovation in novel AI algorithms, systems, and applications.
...
*   **Information Technology R&D Center, MI Department GM Hidetoshi Mishima Award (2019, June):** Honored for conducting a pivotal technical investigation into camera-based recognition systems, laying the foundational technology for a key business unit's autonomous driving project. Title: 'Technical Investigation of Camera Recognition for an Autonomous Driving Project', Mitsubishi Electric Corporation.
...
- **Nikkei, Response, Car Watch, Electronic Design** (Jan. 2018)
  - Widespread press coverage on the announcement of our proprietary object-recognition AI for next-generation vehicles. ([Nikkei Article](https://www.nikkei.com/article/DGXMZO25842710Y8A110C1000000/) | [Company Release](https://www.mitsubishielectric.com/news/2018/0117.html))
