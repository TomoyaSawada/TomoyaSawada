...
### Awards  
- Director of Export Control Hiroyuki Ueda Award, T.Sawada(2022, June) 'Realization of data handling risk minimization in overseas cloud for data linkage and data-driven business', Mitsubishi Electric Corporation. 
...
### Patents
- "推論装置、推論方法及び推論プログラム"、澤田友哉、（三菱電機株式会社）、登録番号 PCT/JP2022/029598. 
- "推論装置、推論方法及び推論プログラム"、澤田友哉、（三菱電機株式会社）、登録番号 PCT/JP2022/029597. 　
